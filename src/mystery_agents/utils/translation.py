...
def translate_content(state: GameState) -> GameState:
    ...
    # NOTE: We do NOT translate custom_epoch_description or custom_theme_description
    # because these are provided by the user in their preferred language,
    # not generated by the LLM in English
    ...
    # NOTE: custom_epoch_description and custom_theme_description are NOT translated
    # because they're provided by the user in their preferred language
