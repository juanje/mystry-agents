...
# V1: World Validator
V1_WORLD_VALIDATOR_SYSTEM_PROMPT = """You are a world consistency validator for mystery party games.
...
V2_GAME_LOGIC_VALIDATOR_SYSTEM_PROMPT = """You are a logic validation expert for mystery party games.
